<template>
  <div class="container" id="group"></div>
</template>
...
import { DynamicGroup, DndPanel } from '@logicflow/extension'
import CustomGroup from '@/views/custom/group'
...
function init() {
  const lf = new LogicFlow({
    container: document.querySelector('#group') as HTMLElement,
    grid: true,
