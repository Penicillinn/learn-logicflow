<template>
  <div class="container" id="adapter"></div>
  <Modal ref="modelRef" />
</template>
...
import { DndPanel, SelectionSelect, Control, BpmnAdapter } from '@logicflow/extension'
...
function init() {
  const lf = new LogicFlow({
    container: document.querySelector('#adapter'),
    grid: true,
  })
